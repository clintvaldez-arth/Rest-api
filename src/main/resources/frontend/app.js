...
async function initializeStudentFormById(id) {
    try {
        ...
        // button change when edit button is triggered
        const submitBtn = document.getElementById("submitBtn");
        submitBtn.textContent = "Update";
        submitBtn.style.backgroundColor = "#007bff";

        // clear validation styles when edit button is triggered
...
async function logoutUser() {
    try {
        ...
        try {
            ...
            console.error("Browser credential cache cleared.");
        }
        window.location.reload();

    } catch (error) {
        console.error("Logout transmission failed:", error);
    }
}
